...
def main():
    ...
    # draw_multi_category_scatter_plot(
    #     total_df, 'min_period', 'error_percentage', 
    #     ['task_count', 'max_wcet_period'],
    #     'Min Period vs Error Percentage by Max Period and Max Utilization',
    #     'Min Period', 'Error Percentage (%)',
    #     show_plot=True, save_plot=True, output_dir=total_analysis_dir,
    #     legend_loc='upper right', fontsize=12,
    #     category_colors=['red', 'blue', 'green', 'orange'],
    #     category_markers=['o', 's', '^', 'v'],
    ...
    draw_multi_category_scatter_plot(
        total_df, 'max_wcet_period', 'error_percentage', 
        ['task_count', 'max_period'],
        'Max WCET/Period vs Error Percentage by Max Period and Max Utilization',
        r'Job utilization $C/T$', r'Error percentage $\Delta/l(\overleftarrow{ac})$ (%)',
        show_plot=True, save_plot=True, output_dir=total_analysis_dir,
