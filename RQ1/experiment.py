...
def main():
    ...
    TASK_COUNT = 10               # Number of tasks in each chain {2, 3, 4, 5, 6, 7, 8, 9, 10}
    NUM_PROFILES = 20            # Number of random profiles to generate
    SIMULATION_DURATION = MAX_PERIOD * TASK_COUNT * 3  # Simulation duration in ms (3T + 3\sumT)
    TIME_UNIT = "ms"             # Time unit
    
    # Simulation parameters
    SIMULATION_REPEATS = 50       # Number of simulation runs per profile
    BASE_SEED = 111               # Base random seed for reproducibility
